...
//! [`crate::code::DEFAULT_GUEST_TIMEOUT`] via [`crate::code::ExecOptions`].
//! These bound provider waits and awaited native-tool calls; a *synchronous*
//! guest loop (see [`crate::code`]) is not interruptible and is not covered.
        ...
        Arc::new(move |req: crate::code::AgentRequest| {
            ...
            Box::pin(async move {
                ...
                let per_rt = req
                    ...
                    .map_or(DEFAULT_ROUND_TRIP_TIMEOUT, Duration::from_millis);
                let opts = SubagentOptions {
                    system: agent.system_prompt.clone(),
                    timeout: per_rt,
                    total_timeout: Some(per_rt * 20),
                };
