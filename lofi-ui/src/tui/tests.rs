...
#[test]
fn greedy_wrap_lines_matches_expectations() {
    use super::app_render::greedy_wrap_lines;
    assert_eq!(greedy_wrap_lines("", 10), 1);
    assert_eq!(greedy_wrap_lines("hello world", 20), 1);
    assert_eq!(greedy_wrap_lines("hello world", 6), 2);
    // A word wider than the row hard-breaks.
    assert_eq!(greedy_wrap_lines("abcdefghij", 5), 2);
}
