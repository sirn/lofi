...
pub(crate) enum Mode {
    ...
    Navigate,
    Select,
    /// Shell-policy confirmation: y = allow, n/Esc = deny.
    Confirm,
}
...
pub(crate) struct App {
    ...
    /// Current modal focus.
    mode: Mode,
    /// Pending shell-policy confirmation request (when `mode == Confirm`).
    pending_confirm: Option<lofi_core::ConfirmRequest>,
