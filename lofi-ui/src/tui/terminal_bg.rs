...
//!
//! The query goes out on stdout and the terminal replies on the tty as
//! `ESC ] 11 ; rgb:RRRR/GGGG/BBBB BEL` (each component 1–4 hex digits,
//! scaled). The shared tty event reader parses startup replies and later
//! replies triggered by color-scheme change notifications.
