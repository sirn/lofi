use crate::support::{
    anthropic_text_response, anthropic_thinking_response, anthropic_tool_response,
    fragmented_tool_response, google_text_response, google_tool_response, parallel_tool_response,
    responses_response, responses_tool_response, text_response, transcript_text, Fixture,
    MockServer, WAIT,
};
