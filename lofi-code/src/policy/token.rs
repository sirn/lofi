...
mod tests {
    ...
    fn trailing_backslash_errors_instead_of_panicking() {
        // A final backslash consumes input to end-of-input inside `read_word`,
        // leaving an empty word and `pos == len`; the error path must not
        // index past the end. This used to panic with an out-of-bounds index.
