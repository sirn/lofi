//! Shared output truncation for the sandbox tools, mirroring Pi's
//! `truncate.ts`: a line limit and a byte limit, whichever is hit first.
...
/// Default line budget, matching Pi's `DEFAULT_MAX_LINES`.
pub const DEFAULT_MAX_LINES: usize = 2000;
/// Default byte budget, matching Pi's `DEFAULT_MAX_BYTES` (50 KB).
pub const DEFAULT_MAX_BYTES: usize = 50 * 1024;
/// Maximum chars per grep match line, matching Pi's `GREP_MAX_LINE_LENGTH`.
